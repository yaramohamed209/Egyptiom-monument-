...
function Monument3() {
  ...
  const input = data.Monuments[3].description;
    ...
    <div className="app">
      ...
      <select onChange={(e) => setFrom(e.target.value)}>
        ...
        <div class="more">
          ...
          <div class="card5">
            <div class="content">
              <img class="A1" src="/images/Music/M3.jpg" alt="" />
            </div>
          </div>
          <div class="card5">
            <div class="content">
              <img class="A1" src="/images/Music/M4.jpg" alt="" />
            </div>
          </div>
          <div class="card5">
            <div class="content">
...
const defaultBlurb = data.Monuments[3].description;
