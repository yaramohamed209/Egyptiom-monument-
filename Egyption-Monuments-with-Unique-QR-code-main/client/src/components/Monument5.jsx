...
function Monument5() {
  ...
  const input = data.Monuments[5].description;
    ...
    <div className="app">
      ...
      <select onChange={(e) => setFrom(e.target.value)}>
        ...
        <div class="more">
          <div class="card5">
            <div class="content">
              <img class="A1" src="/images/Mahmal/H2.jpg" alt="" />
            </div>
          </div>
          <div class="card5">
            <div class="content">
              <img class="A1" src="/images/Mahmal/H3.jpg" alt="" />
            </div>
          </div>
          <div class="card5">
            <div class="content">
              <img class="A1" src="/images/Mahmal/H4.jpg" alt="" />
            </div>
          </div>
          <div class="card5">
            <div class="content">
              <img class="A1" src="/images/Mahmal/H5.jpg" alt="" />
            </div>
          </div>
        </div>
        <div class="uiunit">
...
const defaultBlurb = data.Monuments[5].description;
